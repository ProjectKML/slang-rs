...
impl CompilerOptionName {
    ...
    pub const MATRIX_LAYOUT_COLUMN: Self = Self(sys::slang_CompilerOptionName_MatrixLayoutColumn as _);
    ...
    pub const DUMP_WARNING_DIAGNOSTICS: Self = Self(sys::slang_CompilerOptionName_DumpWarningDiagnostics as _);
    ...
    pub const REPORT_DOWNSTREAM_TIME: Self = Self(sys::slang_CompilerOptionName_ReportDownstreamTime as _);
    pub const REPORT_PERF_BENCHMARK: Self = Self(sys::slang_CompilerOptionName_ReportPerfBenchmark as _);
    pub const SKIP_SPIRV_VALIDATION: Self = Self(sys::slang_CompilerOptionName_SkipSPIRVValidation as _);
    ...
    pub const SOURCE_EMBED_LANGUAGE: Self = Self(sys::slang_CompilerOptionName_SourceEmbedLanguage as _);
    pub const CAPABILITY: Self = Self(sys::slang_CompilerOptionName_Capability as _);
    pub const DEFAULT_IMAGE_FORMAT_UNKNOWN: Self = Self(sys::slang_CompilerOptionName_DefaultImageFormatUnknown as _);
    pub const DISABLE_DYNAMIC_DISPATCH: Self = Self(sys::slang_CompilerOptionName_DisableDynamicDispatch as _);
    pub const DISABLE_SPECIALIZATION: Self = Self(sys::slang_CompilerOptionName_DisableSpecialization as _);
    pub const FLOATING_POINT_MODE: Self = Self(sys::slang_CompilerOptionName_FloatingPointMode as _);
    pub const DEBUG_INFORMATION: Self = Self(sys::slang_CompilerOptionName_DebugInformation as _);
    pub const LINE_DIRECTIVE_MODE: Self = Self(sys::slang_CompilerOptionName_LineDirectiveMode as _);
    ...
    pub const VULKAN_BIND_GLOBALS: Self = Self(sys::slang_CompilerOptionName_VulkanBindGlobals as _);
    pub const VULKAN_INVERT_Y: Self = Self(sys::slang_CompilerOptionName_VulkanInvertY as _);
    pub const VULKAN_USE_DX_POSITION_W: Self = Self(sys::slang_CompilerOptionName_VulkanUseDxPositionW as _);
    pub const VULKAN_USE_ENTRY_POINT_NAME: Self = Self(sys::slang_CompilerOptionName_VulkanUseEntryPointName as _);
    pub const VULKAN_USE_GL_LAYOUT: Self = Self(sys::slang_CompilerOptionName_VulkanUseGLLayout as _);
    pub const VULKAN_EMIT_REFLECTION: Self = Self(sys::slang_CompilerOptionName_VulkanEmitReflection as _);
    pub const GLSL_FORCE_SCALAR_LAYOUT: Self = Self(sys::slang_CompilerOptionName_GLSLForceScalarLayout as _);
    pub const ENABLE_EFFECT_ANNOTATIONS: Self = Self(sys::slang_CompilerOptionName_EnableEffectAnnotations as _);
    pub const EMIT_SPIRV_VIA_GLSL: Self = Self(sys::slang_CompilerOptionName_EmitSpirvViaGLSL as _);
    pub const EMIT_SPIRV_DIRECTLY: Self = Self(sys::slang_CompilerOptionName_EmitSpirvDirectly as _);
    pub const SPIRV_CORE_GRAMMAR_JSON: Self = Self(sys::slang_CompilerOptionName_SPIRVCoreGrammarJSON as _);
    ...
    pub const DEFAULT_DOWNSTREAM_COMPILER: Self = Self(sys::slang_CompilerOptionName_DefaultDownstreamCompiler as _);
    ...
    pub const LOAD_REPRO_DIRECTORY: Self = Self(sys::slang_CompilerOptionName_LoadReproDirectory as _);
    pub const REPRO_FALLBACK_DIRECTORY: Self = Self(sys::slang_CompilerOptionName_ReproFallbackDirectory as _);
    pub const DUMP_AST: Self = Self(sys::slang_CompilerOptionName_DumpAst as _);
    pub const DUMP_INTERMEDIATE_PREFIX: Self = Self(sys::slang_CompilerOptionName_DumpIntermediatePrefix as _);
    ...
    pub const PREPROCESSOR_OUTPUT: Self = Self(sys::slang_CompilerOptionName_PreprocessorOutput as _);
    ...
    pub const VERIFY_DEBUG_SERIAL_IR: Self = Self(sys::slang_CompilerOptionName_VerifyDebugSerialIr as _);
    ...
    pub const VALIDATE_UNIFORMITY: Self = Self(sys::slang_CompilerOptionName_ValidateUniformity as _);
    ...
    pub const SAVE_STD_LIB_BIN_SOURCE: Self = Self(sys::slang_CompilerOptionName_SaveStdLibBinSource as _);
    pub const TRACK_LIVENESS: Self = Self(sys::slang_CompilerOptionName_TrackLiveness as _);
    pub const PARAMETER_BLOCKS_USE_REGISTER_SPACES: Self = Self(sys::slang_CompilerOptionName_ParameterBlocksUseRegisterSpaces as _);
    pub const COUNT_OF_PARSABLE_OPTIONS: Self = Self(sys::slang_CompilerOptionName_CountOfParsableOptions as _);
    pub const DEBUG_INFORMATION_FORMAT: Self = Self(sys::slang_CompilerOptionName_DebugInformationFormat as _);
    pub const VULKAN_BIND_SHIFT_ALL: Self = Self(sys::slang_CompilerOptionName_VulkanBindShiftAll as _);
    pub const GENERATE_WHOLE_PROGRAM: Self = Self(sys::slang_CompilerOptionName_GenerateWholeProgram as _);
    pub const USE_UP_TO_DATE_BINARY_MODULE: Self = Self(sys::slang_CompilerOptionName_UseUpToDateBinaryModule as _);
}
...
impl GlobalSession {
    ...
    #[inline]
    pub fn find_profile(&self, name: *const c_char) -> ProfileID {
